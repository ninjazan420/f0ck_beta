...
export default function RegisterClient() {
    ...
    try {
      const response = await fetch('/api/auth/register', {
        ...
        body: JSON.stringify({
          username,
          password,
          email: email || undefined // nur senden wenn ausgefüllt
        }),
      });
  ...
  return (
    <div className="min-h-[calc(100vh-36.8px)] flex flex-col">
      <StatusBanner show={showRegisterBanner} message="Registration successful!" />
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button className="relative h-12 w-full mt-6 rounded-lg overflow-hidden transition-all duration-500 group" disabled={loading}>
